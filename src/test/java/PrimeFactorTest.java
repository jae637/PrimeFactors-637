...
class PrimeFactorTest {
    ...
    void primeFactorTest4(){
        assertEquals(Arrays.asList(2,2),pf.of(4));
    }
    @Test
    void primeFactorTest6(){
        assertEquals(Arrays.asList(2,3),pf.of(6));
    }
    @Test
    void primeFactorTest9(){
        assertEquals(Arrays.asList(3,3),pf.of(9));
    }
    @Test
    void primeFactorTest12(){
        assertEquals(Arrays.asList(2,2,3),pf.of(12));
    }
